...
TestPanel::TestPanel(s16 x, s16 y, u16 width, u16 height, u32 flags, FontBase* font) : ScrollingPanel(x, y, width, height, flags, font) {
...
void TestPanel::draw(Rect clipRect) {
	...
	port->drawText(30 + getCanvasX(), 60 + getCanvasY(), _font, "Scrolling Panel Test", woopsiRGB(0, 0, 15));
