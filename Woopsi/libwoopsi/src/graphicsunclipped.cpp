...
void GraphicsUnclipped::floodFill(s16 x, s16 y, u16 newColour) {
...
bool GraphicsUnclipped::popStack(s16* x, s16* y, WoopsiArray<s32>* stack) { 
	if (stack->size() > 0) { 
...
void GraphicsUnclipped::pushStack(s16 x, s16 y, WoopsiArray<s32>* stack) {
